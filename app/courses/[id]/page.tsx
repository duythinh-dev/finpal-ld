                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="text-gray-700">
                      ...
                      <p className="text-start">
                        Anh <span className="font-semibold">Trọng</span> hiện
                        đang là{" "}
                        <span className="font-semibold ">
                          Performance Management & Analysis Manager
                        </span>{" "}
                        tại Prudential Vietnam, với hơn 8 năm kinh nghiệm phân
                        tích trong các lĩnh vực Tài chính ngân hàng, Bảo hiểm,
                        Sản xuất. Ngoài ra anh là:
                      </p>
                      ...
                      <div className="space-y-1 ml-2 md:ml-6">
                        <ul className="list-disc ml-6 text-left space-y-2">
                          ...
                          <li>
                            ...
                            của{" "}
                            <span className="font-semibold">DataTecHub</span> -
                      ...
                      {/* Technical Expertise */}
                      <p className="text-start">
                        Anh có kinh nghiệm kiến trúc sư dữ liệu cũng như ứng
                        dụng các công cụ BI tự động hóa (RPA - robotic process
                  ...
                  <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-3">
                      <p className="text-white/90 text-sm">
                        ...
                        các anh chị. Mong anh chị giúp trả lời 3 câu hỏi dưới
                        đây.
                      </p>

                      <p className="text-white/90 text-sm">
                        Anh chị đánh giá mức độ của mình phải sử dụng các ứng
                        dụng Microsoft office (Word, Excel, PowerPoint...) trên
                        công thời gian làm việc của anh chị như thế nào
                      </p>
                                  ...
                                  <Checkbox
                                    ...
                                    onCheckedChange={() => {
                                      setFormData((prev) => {
                                        ...
                                        if (
                                          prev.appKnowledge.includes("none")
                                        ) {
                                          return {
                                            ...prev,
